...
public class RoleEnum {
    public static final String SAVE_ENTRY ="SAVE_ENTRY";
    public static final String SAVE_BLOCK ="SAVE_BLOCK";
    public static final String VIEW_BLOCK_REPORT ="VIEW_BLOCK_REPORT";
